      ...
      <div className="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6 items-center">
            ...
            <Link to="/product" className="text-zinc-600 dark:text-zinc-400 hover:text-green-800 transition-colors duration-300 font-headline">Organic</Link>
          </div>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Link to="/cart" className="relative p-2 hover:bg-green-50/50 dark:hover:bg-green-900/20 transition-colors duration-300 rounded-full scale-95 active:scale-90 transition-transform">
            ...
            <span className="absolute top-0 right-0 bg-secondary text-on-secondary text-[10px] font-bold px-1.5 py-0.5 rounded-full">3</span>
          </Link>
        </div>
      </div>
    </nav>
