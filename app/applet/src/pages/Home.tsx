      ...
      <section className="bg-surface-container-low py-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: 'Tropical Pineapple', desc: 'Sweet & Tangy • 1 Unit', price: '₹85.00', tag: 'In Season', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB_MKKbWZYcaemxlkS-Tcnb6YEX5D1h1PfN442-Us5JAjnAWcl8gDnWom6ouaYmMS02-2QkqPfGQO06A1DamPjja5_WhudmiHLYN0t7EtdqE9A4KDOHTCXJRsPYKOKzfc2WO2vSfCibU1GtEFwLHOYFa04hsMAag24W_zZ1Sp5-fKhKopaaP5IVFlEBb57liau-K0mYcN-ylWBQVhPBauxb4puiPRM241h8Wa-Ybwsw9nPLikssWV7SQgKIBtmzdlKCmM1Iere56WA' },
              { name: 'Organic Potatoes', desc: 'Farm fresh • 1 Kg', price: '₹40.00', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCYO4IPSHug-Ex9s1ZAD6D255BkBUwscVazNog4qLVlWcCYEA-SazKkoipka34RBR7S79KW8TsayGFTWfGYjLbnjXNXCmHvl5jvGN0DXyhq4zfGrqY6vtTA4oaqWfJo7-QMOpK5h2awnCZ1GuE0OFKURj-JK1-TuMwOok2RZPHDICvASRZJb11HI7Elc0WMyqw7OMcJkyOd-R8irbgrUrL8VKHudzio0e98BXsGK-owDyJl-eo2XqPeaHHx_o7cMto85UAMm_rcM6c' },
              { name: 'Butter Avocado', desc: 'Rich & Creamy • 500g', price: '₹120.00', tag: 'Limited', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDLUhdd5PsQYxuix_UB_bheKeXtO1U_HFpVVx3KR8j6lqpClwfqrH8QiC3DzfOP9sTZRN5zCS_2xp_mopeQkyGWC9lotgtSvEIyQPiyBwh5Q98c8yCqZF5eYm4K0jG1iUxL-c2PPARoF2E4Dcl_ff15vpoCq9dSqBos2n_X0z1Pbwt_BocX-LuFfPz1qjAKnNxdzEcfF996sW_sLR2tMWYG4wjXgn-vQyUf6qtqg69d5K5TpKNNYxSSNEJ_aWfPqDZjxP9SSOCDTpI' },
              { name: 'Cherry Tomatoes', desc: 'Vine-ripened • 250g', price: '₹35.00', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAWk4eP091Z4vxPJ47sAtFURkko8BsRPX7_-Y3Gzv9m8Jrk9QrdEOyk0F2CqB0GINTylK568cMYCMbFmh-OAPvDF8EGAFRAvJorCkLSMdy-fYRir9gcW4axokIlz7_Y-decGlp5Z5nzW0F4Vb3rgrITo2QOE2IhFqTaOlNRiv6krZypBBRv7GggLSTqmnUxFSXLaFIt-6JZ_g80hNOutm6tO7CXseFuRbH-M8Jg1M5CtbTkROEpGnjhlAiDXz6O2nPx4fswl4nRWD8' }
            ].map((item, i) => (
              <div key={i} className="group bg-surface-container-lowest rounded-[2rem] p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 relative overflow-hidden">
                {item.tag && (
                ...
                <Link to="/product" className="block aspect-square rounded-2xl overflow-hidden mb-6 bg-surface-container">
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <button className="w-12 h-12 bg-primary rounded-2xl text-on-primary flex items-center justify-center shadow-lg shadow-primary/20 active:scale-90 transition-transform">
